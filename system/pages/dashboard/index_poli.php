...
<html lang="en">
    ...
    <div class="container">
      ...
      <footer class="footer">
        <center>RSSI <?php echo date("Y");?></p></center>
      </footer> 
	  </center>
    </div>
  	</body>
								...
								loket = '<div class=col-md-'+dkolom+'>'+
											'<div class="'+ i +
											 ' jumbotron" style="padding-top:20px;padding-bottom:20px;">'+
												...
												'<button class="btn btn-primary" type="button"><span class="glyphicon glyphicon-credit-card">&nbsp;</span>'+ gg[<?php echo $nomorPoli;?>] +'</button>'+
											'</div>'+
										'</div>';
								$(".loket").append(loket);
						}
