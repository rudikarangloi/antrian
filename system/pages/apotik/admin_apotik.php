...
<div class="card text-center">
  ...
  <div class="card-body">
    <h4 class="card-title">Administrator Antrian Apotik</h4>
									...
									'<div class="'+ i +
									 ' jumbotron" style="padding-top:20px;padding-bottom:20px;">'+
										...
										'<button class="btn btn-primary" type="button">'+											
											'<a href="../apotik/index.php?nomor_loket='+i+'" class="btn btn-primary"> '+ gg[i-1] +'</a>'+
										'</button>'+
									'</div>'+
								'</div>';
						$(".loket").append(loket);
		  ...
		  <div class="col-md-12">
			<div class="card" style="width: 20rem;">
				<div class="card-body">
				  ...
				  <a href="../apotik/client.php" class="btn btn-primary">Klik disini</a>
				</div>
			  </div>
			</div>
		</div>  
