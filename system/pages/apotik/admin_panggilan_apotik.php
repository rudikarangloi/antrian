...
<div class="card text-center">
  ...
  <div class="card-body">
    <h4 class="card-title">Panggilan Antrian</h4>
...
<div class="row loket">
  ...
  $("document").ready(function(){
    ...
    setInterval(function() {
      $.post("../apps/setting_loket_apotik.php", function( data ){
						...
						loket = '<div class=col-md-'+dkolom+'>'+
											'<div class="'+ i +
											 ' jumbotron" style="padding-top:5px;padding-bottom:5px;">'+
												...
												'<button class="btn btn-primary" type="button" style="height:40px;padding-top:0">'+
												'<a href="index_apotik.php?nomor_loket='+i+'" class="btn btn-primary"> '+ gg[i-1] +'</a>'+
		  ...
		  <div class="col-md-12">
			<div class="card" style="width: 20rem;">
				<div class="card-body">
				  ...
				  <a href="../client_apotik/index.php" class="btn btn-primary">Klik disini</a>
				</div>
			  </div>
			</div>
		</div>  
...
<br>
  ...
  <div class="card-footer text-muted">
     <i class="fa fa-copyright" aria-hidden="true"></i> Sistem Antrian 2018
  </div>
